...
export const TestimonialCard: React.FC<TestimonialCardProps> = ({}) => {
    ...
    return (
        <div className="h-[40rem] bg-black w-full dark:bg-black bg-grid-white/[0.2] dark:bg-grid-white/[0.2] relative flex flex-col items-center justify-center overflow-hidden">
